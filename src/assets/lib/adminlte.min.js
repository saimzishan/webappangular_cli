...
if ("undefined" == typeof jQuery) throw new Error("This site requires jQuery"); + function(a) {
    "use strict";
...
/*	 function setDarkTheme() {
			document.getElementById('style1').href = "dist/css/Dark.css";
			document.getElementById('style2').href = "dist/css/skins/skin-dark.css"; 
		}
		
	 function setDefaultTheme() {
			document.getElementById('style1').href = "dist/css/AdminLTE.min.css";
			document.getElementById('style2').href = "dist/css/skins/skin-blue-light.css";
		}
